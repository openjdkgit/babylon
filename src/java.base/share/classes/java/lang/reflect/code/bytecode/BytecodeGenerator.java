...
public final class BytecodeGenerator {
    ...
    public static <O extends Op & Op.Invokable> byte[] generateClassData(MethodHandles.Lookup lookup,
        ...
        // Compact locals of the generated bytecode and remove empty try blocks from the exception table
        return ClassFile.of().transform(ClassFile.of().parse(classBytes), LocalsCompactor.INSTANCE);
    }
